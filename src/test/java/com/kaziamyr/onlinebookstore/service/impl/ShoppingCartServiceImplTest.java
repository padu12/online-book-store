...
class ShoppingCartServiceImplTest {
    ...
    void addBookToShoppingCart_validBook_returnCartItemDto() {
        ...
        CartItemDto actual = shoppingCartService.addBook(cartItemRequestDto);
    ...
    void updateBookInShoppingCart_validId_returnCartItemDto() {
        ...
        CartItemDto actual = shoppingCartService.updateBook(
    ...
    void deleteBookFromShoppingCartById_validId_returnNothing() {
        assertDoesNotThrow(
                () -> shoppingCartService.deleteBookById(VALID_BOOK_ID)
        );
    }
